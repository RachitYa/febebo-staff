...
const USER_PROFILES = {
  1: { type: 'upcoming', dateOfJoining: '10 Mar 2025', dateOfTokenAmount: '01 Mar 2025', name: 'Arjun Mehta', dob: '14 Jun 2001', email: 'arjun.mehta@gmail.com', aadhar: '7412 5836 9021', address: 'B-204, Aashiana Colony, Lucknow, UP - 226012', permanentAddress: 'B-204, Aashiana Colony, Lucknow, UP - 226012', correspondingAddress: 'B-204, Aashiana Colony, Lucknow, UP - 226012', college: 'AKTU Lucknow', careerStatus: 'Student', fatherName: 'Harish Mehta', fatherPhone: '+91 9415227843', motherName: 'Sunita Mehta', motherPhone: '+91 9415227812', parentsAddress: 'B-204, Aashiana Colony, Lucknow, UP - 226012', joiningDate: '10 Mar 2025', tentativeLeaving: '09 Mar 2026', roomNo: 15, bedNo: 3, rent: 10000, token: 5000, pending: 5000, securityAmt: 3000, meterUnit: 1240, meterRatePerUnit: 8 },
  2: { type: 'current', bloodGroup: 'B+', schoolAddress: 'St. Xavier School, Varanasi', name: 'Ravi Shankar Gupta', dob: '22 Sep 2000', email: 'ravi.s.gupta@gmail.com', aadhar: '3621 9847 5503', address: 'Flat 3B, Shivam Apartments, Sector 18, Noida, UP - 201301', permanentAddress: 'H.No 7, Ravindrapuri Colony, Varanasi, UP - 221005', correspondingAddress: 'Flat 3B, Shivam Apartments, Sector 18, Noida, UP - 201301', college: 'BHU Varanasi', careerStatus: 'Student', fatherName: 'Rajendra Prasad Gupta', fatherPhone: '+91 9839221456', motherName: 'Kamla Gupta', motherPhone: '+91 9839221400', parentsAddress: 'H.No 7, Ravindrapuri Colony, Varanasi, UP - 221005', joiningDate: '15 Jan 2025', tentativeLeaving: '14 Jan 2026', roomNo: 16, bedNo: 1, rent: 9500, token: 4000, pending: 0, securityAmt: 3000, meterUnit: 980, meterRatePerUnit: 8 },
  3: { type: 'notice_period', dateOfLeaving: '19 Aug 2025', name: 'Priya Sharma', dob: '08 Mar 1999', email: 'priya.sharma99@gmail.com', aadhar: '8834 1276 4490', address: 'C-12, DDA Flats, Saket, New Delhi - 110017', permanentAddress: 'H.No 32, Tulsi Nagar, Bhopal, MP - 462003', correspondingAddress: 'C-12, DDA Flats, Saket, New Delhi - 110017', college: null, careerStatus: 'Working', companyName: 'Wipro Technologies Ltd.', companyAddress: 'Sector 126, Noida, UP - 201304', fatherName: 'Dinesh Sharma', fatherPhone: '+91 9977881234', motherName: 'Kavita Sharma', motherPhone: '+91 9977881200', parentsAddress: 'H.No 32, Tulsi Nagar, Bhopal, MP - 462003', joiningDate: '01 Apr 2025', tentativeLeaving: '19 Aug 2025', roomNo: 12, bedNo: 2, rent: 11000, token: 6000, pending: 2500, securityAmt: 3000, meterUnit: 1520, meterRatePerUnit: 8 },
  4: { type: 'upcoming', dateOfJoining: '01 Aug 2025', dateOfTokenAmount: '15 Jul 2025', name: 'Deepak Verma', dob: '29 Nov 2001', email: 'deepak.verma2001@gmail.com', aadhar: '6021 3784 9915', address: 'H.No 88, Pratap Nagar, Agra, UP - 282001', permanentAddress: 'H.No 88, Pratap Nagar, Agra, UP - 282001', correspondingAddress: 'H.No 88, Pratap Nagar, Agra, UP - 282001', college: 'Agra College, Agra', careerStatus: 'Student', fatherName: 'Virendra Verma', fatherPhone: '+91 9412078800', motherName: 'Reena Verma', motherPhone: '+91 9412078811', parentsAddress: 'H.No 88, Pratap Nagar, Agra, UP - 282001', joiningDate: '01 Aug 2025', tentativeLeaving: '31 Jul 2026', roomNo: 17, bedNo: 1, rent: 8500, token: 3500, pending: 3500, securityAmt: 2500, meterUnit: 820, meterRatePerUnit: 8 },
  5: { type: 'current', bloodGroup: 'O+', schoolAddress: 'Carmel Convent School, Ludhiana', name: 'Sneha Kapoor', dob: '14 Feb 2001', email: 'sneha.kapoor01@gmail.com', aadhar: '5543 8812 7760', address: 'H-47, Rajouri Garden, New Delhi - 110027', permanentAddress: '14-B, Gurdev Nagar, Ludhiana, Punjab - 141001', correspondingAddress: 'H-47, Rajouri Garden, New Delhi - 110027', college: null, careerStatus: 'Working', companyName: 'HCL Technologies Ltd.', companyAddress: 'Sector 60, Noida, UP - 201301', fatherName: 'Arun Kapoor', fatherPhone: '+91 9814567890', motherName: 'Meena Kapoor', motherPhone: '+91 9814567800', parentsAddress: '14-B, Gurdev Nagar, Ludhiana, Punjab - 141001', joiningDate: '01 May 2025', tentativeLeaving: '30 Apr 2026', roomNo: 18, bedNo: 3, rent: 10500, token: 5500, pending: 1000, securityAmt: 3000, meterUnit: 1100, meterRatePerUnit: 8 },
};

const VISITOR_HISTORY = [
  { name: 'Harish Mehta',         number: '+91 9415227843', relation: 'Father',         address: 'B-204, Aashiana Colony, Lucknow, UP - 226012',         purpose: 'Monthly visit & fee payment',     timeIn: '10:30 AM', timeOut: '04:45 PM', date: '2025-07-18', idProof: 'Aadhar: 7412 5836 9021' },
  { name: 'Sunita Mehta',         number: '+91 9415227812', relation: 'Mother',         address: 'B-204, Aashiana Colony, Lucknow, UP - 226012',         purpose: 'Dropping homemade food & groceries', timeIn: '12:00 PM', timeOut: '02:30 PM', date: '2025-07-05', idProof: 'Aadhar: 7412 5836 9022' },
  { name: 'Rohit Mehta',          number: '+91 9412345670', relation: 'Elder Brother',  address: 'E-12, Gomti Nagar, Lucknow, UP - 226010',              purpose: 'Collecting documents for college admission', timeIn: '03:00 PM', timeOut: '04:00 PM', date: '2025-06-20', idProof: 'DL: UP41-20180123456' },
  { name: 'Harish Mehta',         number: '+91 9415227843', relation: 'Father',         address: 'B-204, Aashiana Colony, Lucknow, UP - 226012',         purpose: 'Illness – took resident to hospital',  timeIn: '09:00 AM', timeOut: '11:15 AM', date: '2025-05-14', idProof: 'Voter ID: UPL1234567' },
  { name: 'Manoj Kumar Mehta',    number: '+91 9807654321', relation: 'Uncle (Chacha)', address: 'H.No 5, Civil Lines, Bareilly, UP - 243001',           purpose: 'Festival visit (Holi)',              timeIn: '01:00 PM', timeOut: '07:00 PM', date: '2025-03-14', idProof: 'Aadhar: 6612 0034 7781' },
];
